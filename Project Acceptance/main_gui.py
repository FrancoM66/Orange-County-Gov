...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.planfile_Btn.clicked.connect(lambda:search.search_clicked(self,self.planfile_entry.text(),self.development_checkB, self.CIP_checkB)) # custom
        self.select_folder = QtWidgets.QFrame(self.centralwidget)
        self.select_folder.setGeometry(QtCore.QRect(10, 290, 125, 110))
        ...
        self.open_folder_label.setGeometry(QtCore.QRect(30, 10, 84, 16))
        ...
        self.options_pane.setGeometry(QtCore.QRect(10, 400, 141, 151))
        ...
        self.label_4 = QtWidgets.QLabel(self.options_pane)
        self.label_4.setGeometry(QtCore.QRect(20, 10, 42, 16))
